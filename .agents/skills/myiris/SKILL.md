...
myiris/
|-- electron/
|   |-- main.mjs          # TRUNG TAM: Gemini Live, Claude bridge, HUD, Tray, tools (~2700 lines)
...
|-- src/
|   |-- App.tsx            # Renderer chinh (~1350+ lines): mic, audio, UI, gestures
|   |-- components/
...
- .env.example — Template env vars
- electron/main.mjs — Core logic (~2700 lines)
