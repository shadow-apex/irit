...
Two-process Electron app. The Gemini↔Claude bridge is the heart of the system and lives almost entirely in `electron/main.mjs` (~5100 lines — this file has grown well past earlier module-split efforts; see "Known documentation drift" below before trusting any other line-count claim in this repo).
